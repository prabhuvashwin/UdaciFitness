    ...
    if (status === 'undetermined' || status === 'denied') {
      return (
        <View style={styles.center}>
          ...
          <Text>
            Permission required to access location. You can fix this by visiting
            settings and enabling location services for this app. Click on the enable button below
          </Text>
